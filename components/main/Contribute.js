...
//           style = {{margin: -10, top: -5}} title="Kagan" left={() => <List.Icon color="#215A88" icon="folder"/>}/>
//       </TouchableOpacity>
//       <TouchableOpacity>
//         <List.Item 
//           onPress={() => navigation.navigate("CMansaka")}
//           style = {{margin: -10, top: -5}} title="Mansaka" left={() => <List.Icon color="#215A88" icon="folder"/>}/>
//       </TouchableOpacity>
//       <TouchableOpacity>
//         <List.Item 
//           onPress={() => navigation.navigate("CManobo")}
//           style = {{margin: -10, top: -5}} title="Manobo" left={() => <List.Icon color="#215A88" icon="folder"/>}/>
//       </TouchableOpacity>
